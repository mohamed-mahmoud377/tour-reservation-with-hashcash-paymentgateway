...
process.on('SIGTERM',()=>{ // this even heroku does every day to shut down the server and restart it again //this actually done by docker which your app running on when you deploy on heroku
